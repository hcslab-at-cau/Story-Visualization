...
export default function V3ReadingQAView({
  docId,
  chapterId,
  chapterTitle,
  runId,
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    ...
                    {answerResult.answer.citations.map((citation) => (
                      <button
                        key={citation.pid}
                        type="button"
                        onClick={() => document.getElementById(`qa-paragraph-${citation.pid}`)?.scrollIntoView({ behavior: "smooth", block: "center" })}
