...
The popover should be small, with a concise label like "Who?" or "Meaning here". It should show:

- referent or local meaning
- one short contextual note
- a small option to open evidence or more context
...
- it avoids dumping background information
...
No dictionary app, no encyclopedia panel, no chatbot bubble, no large glossary sidebar, no tooltip covering the paragraph.
