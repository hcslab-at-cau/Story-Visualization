# Session Re-entry Recap Prompt

## Goal

Visualize the one-time support shown when a reader returns after a break.

This should feel like a gentle resume card, not a summary chapter.
...
- this appears only after a meaningful session gap
- it helps the reader re-enter the current point
...
- The card feels temporary and respectful.
- The three recap parts are easy to scan.
- The reader can immediately continue reading.
